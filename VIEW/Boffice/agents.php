                                    ...
                                    <?php while ($row = $stmt->fetch(PDO::FETCH_ASSOC)): ?>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                if ($row['role'] === 'administrator') $roleClass = 'bg-danger';
                                                elseif ($row['role'] === 'employee') $roleClass = 'bg-success';
                                                ?>
                                                <span class="badge <?php echo $roleClass; ?> bg-opacity-10 <?php echo str_replace('bg-', 'text-', $roleClass); ?>"><?php echo ucfirst($row['role']); ?></span>
                                            </td>
                                            <td>
                                                <?php
