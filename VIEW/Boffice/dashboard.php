...
<?php $viewAction = $_GET['action'] ?? 'index'; ?>
            ...
            <div class="card shadow p-4 overflow-hidden" style="background: linear-gradient(to right, rgba(var(--bs-primary-rgb), 0.05), transparent);">
                <div class="row align-items-center">
                    ...
                    <div class="col-md-4 text-md-end mt-4 mt-md-0">
                        <a href="/integration/VIEW/Boffice/posts.php?action=show&id=<?= $stats['trending']['id'] ?>" class="btn btn-primary btn-lg rounded-pill px-5">View Publication</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="row mb-4">
        <div class="col-12">
            <form method="GET" action="/integration/VIEW/Boffice/posts.php" class="card shadow border-0 p-3">
        ...
        <div class="col-12">
            <div class="card shadow border-0 overflow-hidden">
                <div class="card-header border-bottom">
                    <h5 class="card-header-title mb-0">List of Publications</h5>
                </div>
                <div class="card-body p-0">
                    <div class="table-responsive">
                        <table class="table align-middle table-hover mb-0">
                            ...
                            <tbody>
                                <?php if(empty($list)): ?>
                                <tr>
                                    <td colspan="6" class="text-center py-4">No publications found matching your criteria.</td>
                                </tr>
                                <?php else: ?>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <?php if(!empty($p['document'])): ?>
                                            <a href="/integration/uploads/<?= $p['document'] ?>" target="_blank" class="text-primary h6" title="Download Document">
                                    ...
                                    <td class="text-center">
                                        <a href="/integration/VIEW/Boffice/posts.php?action=show&id=<?= $p['id'] ?>#comments" class="badge bg-info bg-opacity-10 text-info px-3 py-2 rounded-pill text-decoration-none">
                                            <i class="fa-solid fa-comments me-1"></i> <?= $p['comment_count'] ?>
                                        </a>
                                    </td>
                                    <td><span class="small text-muted"><?= date('d M Y, H:i', strtotime($p['date'])) ?></span></td>
                                    <td class="pe-4 text-end">
                                        <a href="/integration/VIEW/Boffice/posts.php?action=show&id=<?= $p['id'] ?>" class="btn btn-sm btn-light mb-0">View</a>
                                        <a href="/integration/VIEW/Boffice/posts.php?action=edit&id=<?= $p['id'] ?>" class="btn btn-sm btn-primary-soft mb-0"><i class="fa-solid fa-pen-to-square"></i></a>
    ...
    <div class="row g-4 mb-5">
        <div class="col-xxl-8">
            <div class="card shadow h-100">
                <div class="card-header border-bottom">
                    <h5 class="card-header-title">Publication Trends (Real-time Velocity)</h5>
                </div>
                <div class="card-body">
                    <div class="d-flex gap-4 mb-3">
                        ...
                        ?>
                        <h6><span class="fw-light text-primary"><i class="bi bi-square-fill me-1"></i> Publications:</span> <?= array_sum($pubValues) ?> (Total 6mo)</h6>
                        <h6><span class="fw-light text-info"><i class="bi bi-square-fill me-1"></i> Comments:</span> <?= array_sum($stats['trends_comments'] ?? []) ?> (Total 6mo)</h6>
                    </div>
