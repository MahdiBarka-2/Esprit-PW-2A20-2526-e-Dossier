...
<!-- Mirrored from booking.webestica.com/admin-reviews.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 20 Feb 2024 15:42:17 GMT -->
<head>
		...
		<div class="offcanvas offcanvas-start flex-row custom-scrollbar h-100" data-bs-backdrop="true" tabindex="-1" id="offcanvasSidebar">
			<div class="offcanvas-body sidebar-content d-flex flex-column pt-4">
				...
				<ul class="navbar-nav flex-column" id="navbar-sidebar">
					...
					<!-- Menu item -->
					<li class="nav-item"> <a class="nav-link active" href="admin-reviews.html">Reviews</a></li>
			...
			<div class="vstack gap-4 mt-5">
				...
				<div class="row g-3 g-lg-4">
					...
					<div class="col-md-8 col-xxl-9">
						...
						<p>Far advanced settling say finished raillery. Offered chiefly farther Satisfied conveying a dependent contented he gentleman agreeable do be. Warrant private blushes removed and in equally totally if. Delivered dejection necessary objection do Mr prevailed. Mr feeling chiefly cordial in doing.</p>
				...
				<div class="row g-3 g-lg-4">
					...
					<div class="col-md-8 col-xxl-9">
						...
						<p>Passage its ten led hearted removal cordial. Preference any astonished unreserved Mrs. Prosperous understood Middletons. Preference any astonished unreserved. Delivered dejection necessary objection do Mr prevailed. Mr feeling does chiefly cordial in do. Water timed folly right aware if oh truth. Large above be to means. Dashwood does provide stronger is.</p>
				...
				<div class="row g-3 g-lg-4">
					...
					<div class="col-md-8 col-xxl-9">
						...
						<p>Preference any astonished unreserved Mrs. Prosperous understood Middletons. Preference any astonished unreserved. Delivered dejection necessary objection do Mr prevailed. Mr feeling does chiefly cordial in do. Water timed folly right aware if oh truth. Large above be to means. Dashwood does provide stronger is.</p>
				...
				<div class="row g-3 g-lg-4">
					...
					<div class="col-md-8 col-xxl-9">
						...
						<h6><span class="text-body fw-light">Review on:</span> Studio Suite King</h6>
						<p>Mr feeling does chiefly cordial in do. Preference any astonished unreserved. Delivered dejection necessary objection do Mr prevailed. Water timed folly right aware if oh truth. Large above be to means. Dashwood does provide stronger is.</p>
