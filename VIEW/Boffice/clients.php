                ...
                <div class="card shadow">
                    <div class="card-body">
                        ...
                        <div class="table-responsive border-0">
                            <table id="clientTable" class="table align-middle p-4 mb-0 table-hover">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const performSort = function() {
                ...
                if (columnIndex === -1) {
                    alert('Column not found. Try: ID, Name, Email, Status');
                    return;
                }
            ...
            exportPdfBtn.addEventListener('click', function() {
                ...
                element.innerHTML = `
                    <div style="padding: 20px;">
                        <h2 style="text-align: center; color: #066ac9;">Client List - E-Dossier</h2>
                        <hr>
