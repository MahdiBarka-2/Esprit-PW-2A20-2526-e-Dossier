...
<!-- Mirrored from booking.webestica.com/admin-booking-detail.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 20 Feb 2024 15:42:16 GMT -->
<head>
				...
				<ul class="navbar-nav flex-column" id="navbar-sidebar">
					...
					<li class="nav-item">
						...
						<ul class="nav collapse flex-column show" id="collapsebooking" data-bs-parent="#navbar-sidebar">
							...
							<li class="nav-item"> <a class="nav-link active" href="admin-booking-detail.html">Booking Detail</a></li>
						</ul>
					</li>
