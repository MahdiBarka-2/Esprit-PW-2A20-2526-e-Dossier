...
<head>
	...
	<link rel="stylesheet" type="text/css" href="/integration/assets/vendor/apexcharts/css/apexcharts.css">
			...
			<div class="offcanvas-body sidebar-content d-flex flex-column pt-4">
				...
				<ul class="navbar-nav flex-column px-2" id="navbar-sidebar">
					...
					<li class="nav-item sidebar-menu-item mb-2">
						<a href="/integration/VIEW/Boffice/posts.php?action=dashboard" class="nav-link <?= isset($_GET['action']) && $_GET['action'] == 'dashboard' ? 'active' : '' ?>">
					...
					<li class="nav-item sidebar-menu-item mb-2">
						...
						<ul class="nav collapse flex-column show ms-4 mt-2 border-start border-2 border-light ps-2" id="collapsebooking" data-bs-parent="#navbar-sidebar">
							<li class="nav-item sidebar-submenu-item mb-1"> 
								<a class="nav-link <?= (!isset($_GET['action']) || $_GET['action'] == 'index') ? 'active' : '' ?>" href="/integration/VIEW/Boffice/posts.php?action=index">Publications List</a>
							</li>
							<li class="nav-item sidebar-submenu-item"> 
								<a class="nav-link <?= (isset($_GET['action']) && $_GET['action'] == 'create') ? 'active' : '' ?>" href="/integration/VIEW/Boffice/posts.php?action=create">Add/Publish Document</a>
							</li>
						</ul>
					</li>
					...
					<!-- Menu item -->
					<li class="nav-item sidebar-menu-item mb-2"> 
						<a class="nav-link <?= isset($_GET['action']) && $_GET['action'] == 'comments' ? 'active' : '' ?>" href="/integration/VIEW/Boffice/posts.php?action=comments">
					...
					<ul class="nav flex-row align-items-center list-unstyled ms-xl-auto">
						...
						<li class="nav-item dropdown">
							<a class="avatar avatar-sm p-0 " href="#" id="profileDropdown" role="button" data-bs-auto-close="outside" data-bs-display="static" data-bs-toggle="dropdown" aria-expanded="false">
								<img class="avatar-img rounded-circle border border-white border-2 shadow-sm" src="/integration/assets/images/avatar/01.jpg" alt="avatar">
							</a>
								...
								<li class="px-4 mb-3">
									<div class="d-flex align-items-center">
										<div class="avatar me-3">
											<img class="avatar-img rounded-circle shadow" src="/integration/assets/images/avatar/01.jpg" alt="avatar">
										</div>
										<div>
