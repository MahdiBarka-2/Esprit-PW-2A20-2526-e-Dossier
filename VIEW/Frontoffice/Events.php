    ...
    <div class="container d-flex justify-content-between align-items-center">
      ...
      <div class="d-flex align-items-center">
        ...
        <style>
          ...
          /* Fix for Event Card readability in Dark Mode */
          ...
          [data-bs-theme='dark'] .event-meta,
          [data-bs-theme='dark'] .event-desc,
          [data-bs-theme='dark'] .cap-badge {
            color: #f5f5dc !important;
          }
              ...
              <li class="px-3 mb-3">
                <div class="d-flex align-items-center">
                  ...
                  <div>
                    ...
                    <p class="small m-0 text-truncate" style="max-width: 150px;"><?php echo $_SESSION['email'] ?? ''; ?>
                    </p>
                  </div>
                </div>
              </li>
