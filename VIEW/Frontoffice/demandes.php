        ...
        <div class="container d-flex justify-content-between align-items-center">
            ...
            <div class="d-flex align-items-center">
                <nav class="navbar-expand-lg">
                    <ul class="nav">
                        <li class="nav-item"><a class="nav-link fw-bold nav-link-custom"
                                href="/integration/VIEW/Frontoffice/index.php"><?php echo __('home'); ?></a></li>
                        <li class="nav-item"><a class="nav-link nav-link-custom"
                                href="/integration/VIEW/Boffice/index.php"><?php echo __('dashboard'); ?></a></li>
                        <li class="nav-item"><a class="nav-link nav-link-custom"
                                href="/integration/VIEW/Frontoffice/Events.php"><?php echo __('Events'); ?></a></li>
                        <li class="nav-item"><a class="nav-link nav-link-custom"
                ...
                <div class="dropdown ms-3">
                    <button class="btn btn-light btn-sm mb-0 px-2" id="languageDropdown" type="button"
                    ...
                    <ul class="dropdown-menu dropdown-menu-end min-w-auto shadow" aria-labelledby="languageDropdown">
                        <li><a class="dropdown-item <?php echo $lang === 'en' ? 'active' : ''; ?>" href="?lang=en">EN
                                English</a></li>
                        <li><a class="dropdown-item <?php echo $lang === 'fr' ? 'active' : ''; ?>" href="?lang=fr">FR
                                French</a></li>
                        <li><a class="dropdown-item <?php echo $lang === 'ar' ? 'active' : ''; ?>" href="?lang=ar">AR
                                Arabic</a></li>
                    </ul>
                </div>
                ...
                <?php if (isset($_SESSION['user_id'])): ?>
                    ...
                    <div class="dropdown ms-3">
                        ...
                        <ul class="dropdown-menu dropdown-animation dropdown-menu-end shadow pt-3"
                            ...
                            <li class="px-3 mb-3">
                                <div class="d-flex align-items-center">
                                    <div class="avatar me-3">
                                        <img class="avatar-img rounded-circle shadow" src="<?php echo $profile_img; ?>"
                            ...
                            <li><a class="dropdown-item" href="../Boffice/account-settings.php"><i
        ...
        <div class="content">
            ...
            <div class="d-flex flex-column align-items-center text-center mb-5 mt-4">
                <div class="d-flex align-items-center justify-content-center mb-4">
                    <svg width="36" height="36" viewBox="0 0 24 24" fill="none" stroke="var(--bs-primary)"
                        stroke-width="2" class="me-3">
                ...
                <div>
                    <button class="btn btn-primary btn-lg px-5 py-3 text-white fw-bold shadow-sm"
                        style="font-size: 1.25rem; border-radius: 12px;" data-bs-toggle="modal"
            ...
            <div class="container py-5">
                ...
                <div class="row g-4 mb-5">
                    <div class="col-12">
                        <h5 class="fw-bold mb-3"><i class="bi bi-signpost-2 me-2 text-primary"></i>Comment soumettre ?
                        </h5>
                    </div>
                    <div class="col-md-4">
                        <div class="card border-0 shadow-sm text-center p-4"
                            style="border-top:3px solid #376cbe!important;">
                            <div class="bg-primary bg-opacity-10 rounded-circle d-flex align-items-center justify-content-center mx-auto mb-3"
                                style="width:56px;height:56px;"><i class="bi bi-tags fs-3 text-primary"></i></div>
                    ...
                    <div class="col-md-4">
                        <div class="card border-0 shadow-sm text-center p-4"
                            ...
                            <div class="bg-warning bg-opacity-10 rounded-circle d-flex align-items-center justify-content-center mx-auto mb-3"
                                style="width:56px;height:56px;"><i class="bi bi-paperclip fs-3 text-warning"></i></div>
                    ...
                    <div class="col-md-4">
                        <div class="card border-0 shadow-sm text-center p-4"
                            ...
                            <div class="bg-success bg-opacity-10 rounded-circle d-flex align-items-center justify-content-center mx-auto mb-3"
                                style="width:56px;height:56px;"><i class="bi bi-send-check fs-3 text-success"></i></div>
                                ...
                                <div class="card border-0 shadow-sm h-100">
                                    <div class="card-body p-4">
                                        <div class="d-flex justify-content-between align-items-start mb-3">
                                            <span class="badge bg-primary bg-opacity-10 text-primary px-3 py-2 rounded-pill"><i
                                                    class="bi bi-tag me-1"></i><?= htmlspecialchars($d['categorie_nom']) ?></span>
                                            <span class="badge <?= $badgeSoft ?> px-3 py-2 rounded-pill"><i
                                                    class="bi <?= $icon ?> me-1"></i><?= $label ?></span>
                                        </div>
                                        <h6 class="fw-bold mb-1"><i
                                                class="bi bi-person-circle me-2 text-muted"></i><?= htmlspecialchars($d['utilisateur']) ?>
                                        </h6>
                                        <p class="text-muted small mb-1"><i
                                                class="bi bi-envelope me-2"></i><?= htmlspecialchars($d['email']) ?></p>
                                        <p class="text-muted small mb-0"><i
                                                class="bi bi-calendar3 me-2"></i><?= date('d/m/Y', strtotime($d['created_at'])) ?>
                                        </p>
                                    </div>
                                    <div class="card-footer bg-transparent px-4 pb-3 pt-2">
                                        ...
                                        <?php else: ?>
                                            <button class="btn btn-outline-secondary btn-sm w-100" disabled><i
                                                    class="bi bi-lock me-1"></i>Non modifiable</button>
                                        <?php endif; ?>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="modal-content border-0 shadow-lg">
                    <div class="modal-header border-0 pb-0" style="background:linear-gradient(135deg,#1d3461,#376cbe);">
                        <div class="text-white py-2">
                            <h5 class="modal-title fw-bold mb-1"><i class="bi bi-file-earmark-plus me-2"></i>Nouvelle
                                Demande</h5>
                        </div>
                        <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal"></button>
                    </div>
                    <form action="../../CONTROLLER/AjouterDemande.php" method="POST" enctype="multipart/form-data"
                        novalidate>
                        ...
                        <div class="modal-body p-4">
                            <div class="row g-3">
                                ...
                                <div class="col-md-6">
                                    <label class="form-label fw-semibold">Document <span
                                            class="text-danger">*</span></label>
                        ...
                        <div class="modal-footer border-0 pt-0">
                            ...
                            <button type="submit" class="btn btn-primary px-4"><i
                                    class="bi bi-send me-2"></i>Soumettre</button>
                        </div>
                    </form>
                </div>
            </div>
            ...
            <div class="modal-dialog modal-lg modal-dialog-centered">
                <div class="modal-content border-0 shadow-lg">
                    <div class="modal-header border-0 pb-0" style="background:linear-gradient(135deg,#1d5461,#37a0be);">
                        <div class="text-white py-2">
                            <h5 class="modal-title fw-bold mb-1"><i class="bi bi-pencil-square me-2"></i>Modifier la
                                Demande</h5>
                        ...
                        <div class="modal-body p-4">
                            <div class="row g-3">
                                <div class="col-md-6">
                                    <label class="form-label fw-semibold">Nom complet <span
                                            class="text-danger">*</span></label>
                                    <input type="text" name="utilisateur" id="edit_utilisateur" class="form-control"
                                        required>
                                </div>
                                <div class="col-md-6">
                                    <label class="form-label fw-semibold">Email <span
