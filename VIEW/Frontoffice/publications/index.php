							...
							<div class="card shadow p-3 pb-0 h-100">
								...
								<div class="card-body px-3 pb-0 mt-2">
									...
									<ul class="nav nav-divider mb-2 mb-sm-4 text-muted">
										...
										<li class="nav-item"><i class="bi bi-calendar3 me-1"></i><?= date('M j, Y \a\t g:i A', strtotime($p['date'])) ?></li>
										<li class="nav-item text-primary"><i class="bi bi-chat-left-dots me-1"></i><?= $p['comment_count'] ?> Comments</li>
										<?php if(!empty($p['document'])): ?>
											<li class="nav-item text-success fw-bold"><i class="bi bi-paperclip me-1"></i>Document Attached</li>
										<?php endif; ?>
									</ul>
								</div>
								<!-- Card body END -->
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
                    <p class="text-white mb-0 small">&copy; 2026 Edossier Official Repository. All rights reserved.</p>
                </div>
                <div class="col-md-6 text-center text-md-end">
                    <ul class="nav justify-content-center justify-content-md-end list-inline mb-0">
                        <li class="list-inline-item"><a class="nav-link text-white small" href="#">Privacy Policy</a></li>
                        <li class="list-inline-item"><a class="nav-link text-white small" href="#">Terms of Use</a></li>
                    </ul>
                </div>
            </div>
        </div>
