...
$list = $pubCtrl->getAllPublications();
?>
<!DOCTYPE html>
<html lang="en">
				...
				<ul class="navbar-nav navbar-nav-scroll me-auto">
					...
					<li class="nav-item dropdown">
						...
						<ul class="dropdown-menu" aria-labelledby="exploreMenu">
							...
							<li><a class="dropdown-item" href="template/about.html">Architecture Overview</a></li>
							<li><a class="dropdown-item" href="template/contact.html">System Support</a></li>
						</ul>
					</li>

					<!-- Nav item Pages -->
					<li class="nav-item">
						<a class="nav-link" href="/integration/VIEW/Boffice/index.php">
												...
												<div class="d-flex justify-content-between align-items-center">
													...
													<div class="d-flex align-items-center gap-2">
														<?php if (!empty($p['document'])): ?>
																<span class="text-primary tiny" title="Document Attached"><i class="bi bi-paperclip"></i></span>
														<?php endif; ?>
				...
				<div class="row g-4">
					...
					<div class="col-6 col-md-3">
						...
						<ul class="nav flex-column text-primary-hover">
							<li class="nav-item"><a class="nav-link text-body-secondary" href="template/about.html">Our System</a></li>
							<li class="nav-item"><a class="nav-link text-body-secondary p-0 mb-2" href="template/contact.html">Support</a></li>
...
<div class="navbar navbar-mobile">
	<ul class="navbar-nav">
		...
		<!-- Nav item Dashboard -->
		<li class="nav-item"> 
			<a class="nav-link" href="/integration/VIEW/Boffice/index.php"><i class="bi bi-shield-lock fa-fw"></i>
